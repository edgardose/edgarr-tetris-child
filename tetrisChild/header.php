...
<head>
    ...
    <![endif]-->
    <?php } ?>
<meta name="google-site-verification" content="J2m2M7_8FLe2PJDeA0WoDvwuU8jJIs78iVdI-BR2DJc" />    
    <!-- Title Tag
    ================================================== -->
...
<div id="wrap" class="clearfix">
    ...
    if( is_front_page() ) : 
		...
		if ( of_get_option('home_subtitle') !== '' ) {
			...
			if ( !is_paged() ) {
			?>
			<h2 id="homepage-title"><span><?php echo of_get_option('home_subtitle', 'Neta'); ?></span></h2>
		<?php } } ?>
